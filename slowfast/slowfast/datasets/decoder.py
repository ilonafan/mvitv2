...
def pyav_decode(
    ...
    target_fps=30,
    use_offset=False,
    modalities=("visual",), #Add as pull request
    max_spatial_scale=0, #Add as pull request
    min_delta=-math.inf, #Add as pull request
    max_delta=math.inf, #Add as pull request
):
    """
